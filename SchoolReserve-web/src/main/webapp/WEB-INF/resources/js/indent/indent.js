...
var indentGrid = new Ext.grid.GridPanel({
			id : 'indentGrid',
			plugins : [rowEditing],
			store : store,
			region : 'center',
...
indentGrid.getSelectionModel().on('selectionchange',
...
var clearForm = function() {
	...
	indentForm.getForm().reset();
}

var queryForm = function() {
	Ext.Msg.alert('查询', '将开始执行查询！');
}
var indentForm = new Ext.form.FormPanel({
			title : '信息查询',
			width : 200,
			height : 200,
			frame : true,
